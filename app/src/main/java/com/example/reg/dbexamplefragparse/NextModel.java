package com.example.reg.dbexamplefragparse;
...
public class NextModel {
  private String name1,web;
   ...
   private String card_name,imm,imgbb,appTime,anualFee,rewlFee,webvi;
    ...
    public NextModel(String cardname, String imageUrl, String imageback, String approvalTime, String annualFee, String renewalFee, String webdata) {
        card_name=cardname;
        imm=imageUrl;
        imgbb=imageback;
